...
def parse_args():
    ...
    parser.add_argument('--do_save', action='store_true', help='if given, save results')    # 예시1: --do_save
    parser.add_argument('--data', nargs='+', type=str)    # 예시2: --data
...
def main():
    ...
    save_path = os.path.join(args.results_folder, str(folder_name))    # 하위 타깃 폴더 이름
